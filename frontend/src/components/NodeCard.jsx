  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 right-2 flex items-center gap-1.5">
        <button
          onClick={onHide}
          className="px-1.5 py-0.5 text-[10px] rounded bg-gray-800/80 text-gray-300 hover:bg-red-500/70 hover:text-white border border-gray-600/70"
        >
          隱藏
        </button>
      ...
      {stats ? (
        todayABStats ? (
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-gray-400 font-bold min-w-[60px]">當日盈虧:</span>
              <span className={`text-sm font-bold ml-auto ${
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-gray-400 font-bold min-w-[60px]">利息:</span>
              <span className="text-[11px] text-gray-300 ml-auto">{(todayStats?.interest ?? 0).toFixed(2)}</span>
            </div>
            
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-gray-400 font-bold min-w-[60px]">勝率:</span>
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-gray-400 font-bold min-w-[60px]">交易手數:</span>
